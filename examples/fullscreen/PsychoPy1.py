...
screenSize = QtGui.QApplication.desktop().size()

# initialize Windows and Mouse object from PsychoPy
myWin = visual.Window((screenSize.width(),screenSize.height()), monitor='testMonitor', fullscr=False, allowGUI=False, units ='pix', color = bgColor, winType='pyglet')
